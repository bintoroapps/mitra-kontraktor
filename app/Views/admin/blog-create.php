        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= base_url('admin/artikel/create') ?>" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                            <label>Judul</label>
                            <input type="text" class="form-control" name="judul" value="<?= set_value('judul') ?>" placeholder="Judul Artikel">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                            <label>Gambar Utama</label>
                            <input type="file" class="form-control" name="gambar_utama" value="<?= set_value('gambar_utama') ?>" placeholder="Gambar Utama" required>
                            </div>
                        </div>
                        <div class="col-md-10 col-sm-12">
                            ...
                            <select name="kategori_name" class="form-control kategori-val">
                                ...
                                ?>
                                <option value="<?= $c->blog_category_id ?>" <?= set_value('kategori_name') == $c->blog_category_id ? 'selected' : '' ?>><?= $c->blog_category_name ?></option>
                                <?php 
                                    endforeach;
                                    endif; 
                                ?>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                            <label>Tags</label>
                            <input  class="form-control tags" name="tags" value="<?= set_value('tags') ?>" placeholder="Tags">
                            </div>
                        </div>
                        <div class="col-12">
                            <label>Isi Konten</label>
                            <textarea name="konten" class="textarea"><?= set_value('kontent') ?></textarea>
                        </div>
                    </div>
                </div>
