        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Contact Page Template</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="card" style="width: 100%;">
                <div class="card-body">
                  <div class="row">
                    <div class="col-12" style="background-image: url(<?= $contact->contact_page_1_img ? base_url('media/' . $contact->contact_page_1_img) : base_url('images/main-slider/image-4.jpg') ?>); height:230px;">
                      <div class="row">
                        <div class="col-12 mb-3">
                          ...
                          <button class="btn btn-warning mt-4 ml-3 edit-1-title"><i class="fas fa-edit"></i></button>
                            <span style="display:block;" class="ml-3 1-big-title"><?= $contact->contact_page_1_big_title ?></span>
                            <span class="d-block mt-2 ml-3 1-small-title"><?= $contact->contact_page_1_small_title ?></span>
                          </div>
                          <div class="col-md-6 col-sm-12 text-right">
                            <button class="btn btn-warning mt-4 mr-3 edit-1-bread"><i class="fas fa-edit"></i></button>
                            <div style="width: 100%;">
                              <span class="mr-3"><a href="<?= $contact->contact_page_1_bread_link ?>" class="1-bread-1"><?= $contact->contact_page_1_bread_1 ?></a></span>&nbsp;-&nbsp;<span class="mr-3 1-bread-2"><?= $contact->contact_page_1_bread_2 ?></span>
                            </div>
                          </div>
                        </div>
                    </div>
          ...
          <div class="col-md-6 col-sm-12">
            <div class="card">
              <div class="card-body">
                ...
                <span class="2-big-title d-block mb-3"><?= $contact->contact_page_2_big_title ?></span>
                <span class="2-small-title"><?= $contact->contact_page_2_small_title ?></span>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-sm-12">
            <div class="card">
              <div class="card-body">
                <h3 class="text-center">PETA PERUSAHAAN</h3>
              </div>
            </div>
          </div>
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h3 class="text-center">KONTAK PERUSAHAAN</h3>
              </div>
            </div>
          </div>
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h3 class="text-center">LIST LOGO KLIEN</h3>
              </div>
            </div>
          </div>
        </div>
...
$(document).ready(function() {
    $('body').on('click', '.edit-1-img', function() {
      $.ajax({
        type: 'get',
        url: "<?= base_url('admin/tampilan-website/contact/getEditBackground') ?>",
        data: {
          section: '1'
        },
        success(response) {
    ...
    $('body').on('click', '.choose-media-1-background', function() {
      ...
      $.ajax({
        type: 'post',
        url: "<?= base_url('admin/tampilan-website/contact/update') ?>",
        data: {
          act: '1-background',
          image: image
        },
