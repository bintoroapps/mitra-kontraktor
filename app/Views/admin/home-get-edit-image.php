<div class="row">
    ...
    <div class="col-12 mb-3">
        <form id="form-img-<?= $section ?>-<?= $img ?>" action="<?= base_url('admin/tampilan-website/home') ?>" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" name="save" value="save-as-webp" class="float-right mt-3 mr-2 btn btn-success btn-img-<?= $section ?>-<?= $img ?>">Upload & Save as Webp</button>
        </form>
    </div>
</div>
<?php if(isset($media)): ?>
