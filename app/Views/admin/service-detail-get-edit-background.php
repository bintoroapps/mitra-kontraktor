<div class="row">
    <div class="col-12 mb-3">
        <form id="form-background-<?= $section ?>" action="<?= base_url('admin/jasa/layout/' . $id_jasa) ?>" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" class="float-right mt-3 btn btn-primary btn-background-<?= $section ?>">Upload & Save</button>
        </form>
    </div>
</div>
<?php if(isset($media)): ?>
