<div class="row">
    <div class="col-12 mb-3">
        <form id="form-background-<?= $section ?>" action="<?= base_url('admin/tampilan-website/service') ?>" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" name="save" value="save-as-webp" class="float-right mr-2 mt-3 btn btn-success btn-background-<?= $section ?>">Upload & Save as Webp</button>
        </form>
    </div>
</div>
<?php if(isset($media)): ?>
